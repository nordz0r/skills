...
Если задача не про wiki, а про обычные файлы, шары, пользователей, группы или приложения инстанса — это скилл `nextcloud-admin`.
